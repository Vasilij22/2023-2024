...
class info():
    def __init__(self,Produkta_kategorija,Produkta_nosaukums,Tehniskie_raksturojumi,Nomas_cena_dienā,Produkts_pieejams,Nomnieks_vārds,Nomnieks_uzvārds,Nomnieks_p_k,Nomnieks_tel_numurs,Nomas_sākuma_datums,Nomas_beigu_datums):
        ...
        self.Nomnieks_uzvards = Nomnieks_uzvārds
    ...
    def saglabsana2(self):
        with open('Noma info.txt','w', encoding="utf=8") as fails:
            ...
            fails.write(f"Nomnieks_uzvārds: {self.Nomnieks_uzvards}\n")
...
logi2 = [
    ...
    [psg.Text('Nomnieka_vārds'), psg.InputText()],
    [psg.Text('Nomnieka_uzvārds'), psg.InputText()],
    [psg.Text('Nomnieka_p_k'), psg.InputText()],
    [psg.Text('Nomnieka_tel_numurs'), psg.InputText()],
...
logugruppa = [[
    ...
    psg.Button('Aizvert'),
    [psg.Button('Produktu apskate'),
    psg.Button('Nomas apskate')]
]]
...
while True:
    ...
    if event == 'Produktu apskate':
        psg.theme('Blue Mono')
        logi3 = [
                [psg.Text('Produktu Informacija')],
                [psg.Text('Produkta_kategorija:'+ jauns.Produkta_kategorija)],
                [psg.Text('Produkta_nosaukums:'+ jauns.Produkta_nosaukums)],
                [psg.Text('Tehniskie_raksturojumi:'+ jauns.Tehniskie_raksturojumi)],
                [psg.Text('Produkts_pieejams:'+ jauns.Produkts_pieejams)],
                [psg.Text('Atpakaļ.')]

                ]
      
        window = psg.Window('Produktu informacija',logi3)
        event,values = window.read()
        
    if event == 'Nomas apskate':
        psg.theme('Blue Mono')
        logi4 = [
                [psg.Text('Nomnieka Informacija:')],
                [psg.Text('Nomnieka_vārds:'+ jauns.Nomnieks_vārds)],
                [psg.Text('Nomnieka_uzvārds:'+ jauns.Nomnieks_uzvards)],
                [psg.Text('Nomnieka_p_k:'+ jauns.Nomnieks_p_k)],
                [psg.Text('Nomnieka_tel_numurs:'+ jauns.Nomnieks_tel_numurs)],
                [psg.Text('Nomas_sākuma_datums:'+ jauns.Nomas_sākuma_datums)],
                [psg.Text('Nomas_beigu_datums:'+ jauns.Nomas_beigu_datums)],
                [psg.Text('Nomas_cena_dienā:'+ jauns.Nomas_cena_dienā)],
                [psg.Button('Atpakaļ')]
            ]

        window = psg.Window('Nomas informacija',logi4)
        event,values = window.read()
